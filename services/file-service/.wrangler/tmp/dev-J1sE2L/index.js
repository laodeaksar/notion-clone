...
// ../../node_modules/.pnpm/hono@4.12.22/node_modules/hono/dist/helper/factory/index.js
...
var UploadInputSchema = object({
  data: pipe(string(), minLength(1)),
  filename: optional(string()),
  folder: optional(string())
});
var MoveInputSchema = pipe(
  object({
    newKey: optional(pipe(string(), minLength(1))),
    folder: optional(pipe(string(), minLength(1))),
    filename: optional(pipe(string(), minLength(1)))
  }),
  check(
...
// src/storage/cloudinary.storage.ts
var apiBase = /* @__PURE__ */ __name((cloudName) => `https://api.cloudinary.com/v1_1/${cloudName}`, "apiBase");
...
async function buildSignature(params, apiSecret) {
  const sorted = Object.entries(params).filter(([, v2]) => v2 !== void 0 && v2 !== "").sort(([a2], [b]) => a2.localeCompare(b)).map(([k, v2]) => `${k}=${v2}`).join("&");
...
function resourceTypeFromMime(contentType) {
  if (!contentType) return "image";
  if (contentType.startsWith("image/")) return "image";
  if (contentType.startsWith("video/")) return "video";
  return "raw";
}
__name(resourceTypeFromMime, "resourceTypeFromMime");
...
__name(mimeFromFormat, "mimeFromFormat");
async function uploadToCloudinary(input, cloudName, apiKey, apiSecret, defaultFolder) {
  const folder = input.folder ?? defaultFolder;
  const timestamp2 = Math.floor(Date.now() / 1e3);
  const baseName = input.filename ? input.filename.replace(/\.[^.]+$/, "") : crypto.randomUUID();
  ...
  form.append("timestamp", timestamp2.toString());
  ...
  if (!res.ok) {
    ...
    throw new Error(`Cloudinary upload failed: ${text2}`);
  }
...
async function uploadFileToCloudinary(file, cloudName, apiKey, apiSecret, defaultFolder, folder, filename) {
  const resolvedFolder = folder ?? defaultFolder;
  const baseName = filename ? filename.replace(/\.[^.]+$/, "") : file.name ? file.name.replace(/\.[^.]+$/, "") : crypto.randomUUID();
...
__name(uploadFileToCloudinary, "uploadFileToCloudinary");
async function deleteFromCloudinary(publicId, cloudName, apiKey, apiSecret, contentType) {
  const timestamp2 = Math.floor(Date.now() / 1e3);
  const paramsToSign = { public_id: publicId, timestamp: timestamp2 };
  const signature = await buildSignature(paramsToSign, apiSecret);
  ...
  const fallbacks = ["image", "video", "raw"].filter((t) => t !== primary);
...
async function listFromCloudinary(cloudName, apiKey, apiSecret, folder, cursor, limit = 100) {
  ...
  await Promise.all(
    resourceTypes.map(async (resType) => {
      ...
      if (!res.ok) {
        const text2 = await res.text();
        throw new Error(`Cloudinary list (${resType}) failed: ${text2}`);
      }
      const data = await res.json();
  ...
  results.sort((a2, b) => b.uploadedAt.localeCompare(a2.uploadedAt));
...
__name(listFromCloudinary, "listFromCloudinary");
async function headFromCloudinary(publicId, cloudName, apiKey, apiSecret) {
  ...
  for (const resType of ["image", "video", "raw"]) {
    ...
    if (res.status !== 404) {
      const text2 = await res.text();
      throw new Error(`Cloudinary head failed: ${text2}`);
    }
  }
  throw new Error(`Object not found: ${publicId}`);
}
__name(headFromCloudinary, "headFromCloudinary");
async function moveInCloudinary(oldPublicId, newPublicId, cloudName, apiKey, apiSecret, contentType) {
...
__name(moveInCloudinary, "moveInCloudinary");
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/entity.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/logger.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/query-promise.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/column.js
var Column = class {
  static {
    __name(this, "Column");
  }
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/column-builder.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/table.utils.js
var TableName = /* @__PURE__ */ Symbol.for("drizzle:Name");

// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/foreign-keys.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/tracing-utils.js
function iife(fn, ...args) {
  return fn(...args);
}
__name(iife, "iife");

// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/unique-constraint.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/utils/array.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/common.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/enum.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/subquery.js
var Subquery = class {
  static {
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/version.js
var version2 = "0.45.2";

// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/tracing.js
var otel;
var rawTracer;
var tracer = {
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/view-common.js
var ViewBaseConfig = /* @__PURE__ */ Symbol.for("drizzle:ViewBaseConfig");

// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/table.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/sql/sql.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/alias.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/selection-proxy.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/utils.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/int.common.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/bigint.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/bigserial.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/boolean.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/char.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/cidr.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/custom.js
...
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/columns/all.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/table.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/indexes.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/primary-keys.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/casing.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/errors.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/sql/expressions/conditions.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/sql/expressions/select.js
function asc(column) {
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/relations.js
var Relation = class {
  static {
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/view-base.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/dialect.js
var PgDialect = class {
  static {
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/query-builders/query-builder.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/select.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/query-builder.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/utils.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/delete.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/insert.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/refresh-materialized-view.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/update.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/count.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/query.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/query-builders/raw.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/db.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/cache/core/cache.js
var Cache = class {
  static {
    __name(this, "Cache");
  }
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/pg-core/session.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/neon-http/session.js
var rawQueryConfig = {
  arrayMode: false,
  fullResults: true
};
...
// ../../node_modules/.pnpm/drizzle-orm@0.45.2_@cloudflare+workers-types@4.20260524.1_@neondatabase+serverless@0.10_6f6a74bf15dd4c6358b09c99862781ac/node_modules/drizzle-orm/neon-http/driver.js
...
function createFileRepo(db) {
  return {
    ...
    async create(record) {
      ...
      const [file] = await db.insert(files).values({ ...record, createdAt: now, updatedAt: now }).returning();
      return file;
    },
    async move(oldId, newId, newUrl) {
      const existing = await this.findById(oldId);
      if (!existing) return null;
      const now = /* @__PURE__ */ new Date();
      await db.delete(files).where(eq(files.id, oldId));
      const [file] = await db.insert(files).values({ ...existing, id: newId, url: newUrl, updatedAt: now }).returning();
      return file;
    },
    async delete(id) {
...
__name(createFileRepo, "createFileRepo");

// src/repository/quota.repo.ts
function createQuotaRepo(db) {
  return {
    async get(userId) {
      const rows = await db.select().from(userStorageQuotas).where(eq(userStorageQuotas.userId, userId));
      return rows[0] ?? null;
    },
    async upsertAdd(userId, limitBytes, deltaBytes) {
      const now = /* @__PURE__ */ new Date();
      const [row] = await db.insert(userStorageQuotas).values({
        userId,
...
__name(createQuotaRepo, "createQuotaRepo");

// ../../packages/shared/src/types/block.types.ts
var BlockInputSchema = object({
  id: optional(string()),
  pageId: string(),
  type: string(),
  content: unknown(),
...
var BlockUpdateSchema = object({
  type: optional(string()),
  content: optional(unknown()),
  order: optional(number())
});

// ../../packages/shared/src/types/page.types.ts
var PageInputSchema = object({
  title: pipe(string(), minLength(1)),
  parentId: optional(nullable(string()))
});
var PageUpdateSchema = object({
  title: optional(pipe(string(), minLength(1))),
  parentId: optional(nullable(string()))
});
...
var BlockCreatedPayloadSchema = object({
  blockId: string(),
  pageId: string()
});
var BlockUpdatedPayloadSchema = object({
  blockId: string(),
  pageId: string()
});
var BlockDeletedPayloadSchema = object({
  blockId: string(),
  pageId: string()
});
var PageCreatedPayloadSchema = object({
  pageId: string(),
  parentId: optional(nullable(string()))
});
var PageUpdatedPayloadSchema = object({
  pageId: string()
});
var PageDeletedPayloadSchema = object({
  pageId: string()
});
var FileUploadedPayloadSchema = object({
  publicId: string(),
  url: string(),
  provider: picklist(["cloudinary", "r2"])
});
var FileDeletedPayloadSchema = object({
  publicId: string()
});
var FileMovedPayloadSchema = object({
  oldPublicId: string(),
  publicId: string(),
  url: string()
});
...
function createPublisher(queue) {
  return {
    async publish(event) {
      if (queue) {
...
function createFilePublisher(queue) {
  return createPublisher(queue);
}
__name(createFilePublisher, "createFilePublisher");

// src/config.ts
var DEFAULT_UPLOAD_FOLDER = "notion-clone";
var DEFAULT_QUOTA_BYTES = 100 * 1024 * 1024;

// src/services/file.service.ts
function estimateBase64Bytes(base64) {
  const cleaned = base64.endsWith("==") ? base64.slice(0, -2) : base64.endsWith("=") ? base64.slice(0, -1) : base64;
  return Math.ceil(cleaned.length * 3 / 4);
}
__name(estimateBase64Bytes, "estimateBase64Bytes");
function quotaExceededError(used, limit, required) {
  const remaining = Math.max(0, limit - used);
  const err = new Error(
    `Storage quota exceeded. Used ${used} / ${limit} bytes \u2014 ${required} bytes required but only ${remaining} bytes remain.`
  );
  err.status = 507;
  throw err;
}
__name(quotaExceededError, "quotaExceededError");
function createFileService(cloudName, apiKey, apiSecret, db, eventsQueue) {
  const publisher = createFilePublisher(eventsQueue);
  async function enforceQuota(uploadedBy, requiredBytes) {
  ...
  __name(enforceQuota, "enforceQuota");
  async function incrementQuota(uploadedBy, bytes, limit) {
    if (!db) return;
    const quotaRepo = createQuotaRepo(db);
    await quotaRepo.upsertAdd(uploadedBy, limit, bytes).catch((err) => console.error("[file-service] quota increment failed:", err));
  }
  ...
  return {
    ...
    async upload(input, uploadedBy) {
      let quotaLimit = DEFAULT_QUOTA_BYTES;
      if (uploadedBy) {
        const raw2 = input.data.includes(",") ? input.data.split(",")[1] : input.data;
        const estimatedSize = estimateBase64Bytes(raw2);
    ...
    async uploadFile(file, folder, filename, uploadedBy) {
      let quotaLimit = DEFAULT_QUOTA_BYTES;
      if (uploadedBy) {
    ...
    async delete(publicId, deletedBy) {
      let contentType = null;
      let fileSize = 0;
      let actualUploader = null;
      if (db) {
        const repo = createFileRepo(db);
      ...
      if (db) {
        const repo = createFileRepo(db);
        await repo.delete(publicId).catch((err) => console.error("[file-service] DB delete failed:", err));
        const releaseFor = actualUploader ?? deletedBy;
        if (releaseFor && fileSize > 0) {
          const quotaRepo = createQuotaRepo(db);
          await quotaRepo.upsertAdd(releaseFor, DEFAULT_QUOTA_BYTES, -fileSize).catch((err) => console.error("[file-service] quota release failed:", err));
        }
      }
      await publisher.publish({
        type: "file.deleted",
    ...
    async list(folder, cursor, limit) {
    ...
    async move(oldPublicId, input) {
      ...
      if (db) {
        const repo = createFileRepo(db);
        await repo.move(oldPublicId, result.publicId, result.url).catch((err) => console.error("[file-service] DB move failed:", err));
      }
      await publisher.publish({
        type: "file.moved",
...
__name(createFileService, "createFileService");
...
function timingSafeEqual(a2, b) {
  ...
  for (let i = 0; i < a2.length; i++) {
    diff |= a2.charCodeAt(i) ^ b.charCodeAt(i);
  }
  return diff === 0;
}
...
// src/routes/files.ts
var serviceMiddleware = createMiddleware(async (c, next) => {
...
var fileRoutes = new Hono2().use("*", authMiddleware).use("*", serviceMiddleware).get("/quota", async (c) => {
  ...
  const folder = c.req.query("folder") ?? void 0;
  const cursor = c.req.query("cursor") ?? void 0;
  const limitRaw = c.req.query("limit");
  const limit = limitRaw ? Math.min(Math.max(parseInt(limitRaw, 10) || 100, 1), 1e3) : 100;
  try {
  ...
  try {
    if (contentType.includes("multipart/form-data")) {
      ...
      const folder = form.get("folder")?.toString() ?? void 0;
      const filename = form.get("filename")?.toString() ?? void 0;
      const result2 = await c.get("svc").uploadFile(file, folder, filename, uploadedBy);
      return c.json(result2);
    }
    const body = await c.req.json().catch(() => null);
    const parsed = safeParse(UploadInputSchema, body);
    if (!parsed.success) {
  ...
  try {
    const body = await c.req.json().catch(() => null);
    const parsed = safeParse(MoveInputSchema, body);
    if (!parsed.success) {
      return c.json({ error: "Invalid request body", issues: parsed.issues }, 400);
    }
...
// src/routes/index.ts
var routes = new Hono2().get("/", (c) => c.json({ status: "ok", service: "file-service", provider: "cloudinary" })).route("/upload", fileRoutes);

// src/queue/handlers.ts
async function handleFileEvent(event, env2) {
  switch (event.type) {
    case "file.uploaded": {
...
__name(handleFileEvent, "handleFileEvent");
...
var src_default = {
  ...
  async queue(batch, env2) {
    for (const msg of batch.messages) {
      try {
        await handleFileEvent(msg.body, env2);
        msg.ack();
      } catch (err) {
...
// .wrangler/tmp/bundle-0KtsFe/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-0KtsFe/middleware-loader.entry.ts
