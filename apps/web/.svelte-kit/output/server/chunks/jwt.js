...
*/
async function signServerJWT(secret) {
	...
	return `${header}.${payload}.${btoa(String.fromCharCode(...new Uint8Array(sig))).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, "")}`;
}
//#endregion
export { signServerJWT as t };
