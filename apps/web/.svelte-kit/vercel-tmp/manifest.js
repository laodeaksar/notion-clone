	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/pages/_server.ts.js'))
			},
			{
				id: "/api/pages/[id]",
				pattern: /^\/api\/pages\/([^/]+?)\/?$/,
				...
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/pages/_id_/_server.ts.js'))
			},
			{
				id: "/api/search",
				pattern: /^\/api\/search\/?$/,
